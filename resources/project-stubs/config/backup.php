...
return [
    ...
    'backup' => [
        ...
        'source' => [
            ...
            'files' => [
                ...
                'exclude' => [
                    ...
                    base_path('docs'),
                    base_path('scripts/vm'),
                    base_path('tests'),
                    storage_path('app/public/temporary'),
        ...
        'destination' => [
             ...
             */
            'filename_prefix' => config('app.slug') . '-',
    ...
    'monitor_backups' => [
        [
            ...
            MaximumStorageInMegabytes::class => 10 * 1024,
        ],
    ],
    ...
    'cleanup' => [
        ...
        'default_strategy' => [
             ...
             */
            'delete_oldest_backups_when_using_more_megabytes_than' => 10 * 1024,
        ],
    ],
];
